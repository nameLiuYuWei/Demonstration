layui.use(['table','form', 'layedit', 'laydate','upload','laypage', 'layer'], function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field:'szz', title:'生长势'}
            ,{field:'szhj', title:'生长环境'}
            ,{field:'lrrq', title:'录入日期'}
            ,{fixed: 'right', title:'操作', toolbar: '#barDemo'}
        ]]
        ,data: [
            {"gsid":"XJ-YM-2021000081759","szz":"正常","szhj":"良好","lrrq":"2021-03-30"},
            {"gsid":"XJ-YM-2021000081759","szz":"正常","szhj":"良好","lrrq":"2021-03-28"},
        ]
        ,page: true
    });
    ...
    table.on('tool(test)', function(obj){
        ...
        if(obj.event === 'edit'){
            layer.open({
                ...
                area: ['1150px', '400px'],
                content: '../gsmmcx/gsmmszjl.html?ckgs=001'
            });
        }
    });
});