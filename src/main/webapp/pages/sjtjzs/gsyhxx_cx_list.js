layui.use(['table','form', 'layedit', 'laydate','upload','laypage', 'layer'], function(){
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field:'xxr', title:'巡查人'}
            ,{field:'xxtime', title:'巡查时间'}
            ,{field:'stzkqk', title:'树体状况描述'}
            ,{fixed: 'right', title:'操作', toolbar: '#barDemo'}
        ]]
        ,data: [
            {"gsid":"XJ-YM-2021000081759","xxr":"李永进","xxtime":"2021-03-30","stzkqk":"正常"},
            {"gsid":"XJ-YM-2021000081759","xxr":"王均旦","xxtime":"2021-03-28","stzkqk":"正常"},
        ]
        ,page: true
    });
    ...
    table.on('tool(test)', function(obj){
        ...
        if(obj.event === 'edit'){
            layer.open({
                ...
                area: ['1150px', '400px'],
                content: '../gsmmcx/gsmmxc.html?ckgs=001'
            });
        }
    });
});