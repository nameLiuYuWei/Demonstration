var ckdj={"xm":"李永进","sjhm":"13968563892","cqid":"XJ-2021-031202","date1":"2021-03-30","cqdd":"仙居县横溪镇镇头村屏峰岩"}
...
layui.use(['form', 'layedit', 'laydate','upload'], function(){
	...
	$('#cqid').val("XJ-CQ-"+year+month+strDate+strSeconds);
	...
	var cqid = getUrlParam("cqid");
	if(cqid!=""&&cqid!=null&&cqid!=undefined){
