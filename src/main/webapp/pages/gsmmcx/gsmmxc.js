var ckdj={"gsid":"XJ-YM-2021000081759","xcr":"李永进","xctime":"2021-03-30","gsjb":"一级","sg":"8.2","xjzmj":"102","szdd":"仙居县横溪镇镇头村屏峰岩","ghfzdw":"仙居县自然资源和规划局","szs":"正常","stzkms":"正常","ldtjms":"屏峰岩山顶山门往左","yczt":"无","ydcs":"定期巡查养护","lsqkjl":"已落实","bz":"无","demo2":"../gsimg/yangmei1.jpg"}
...
layui.use(['form', 'layedit', 'laydate','upload'], function(){
	...
	if(gsid!=""&&gsid!=null&&gsid!=undefined){
        $('#gsid').val(gsid);
        $('#gsid').attr("disabled","disabled");
    }
